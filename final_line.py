...
class Line:
    ...
    def get_valid_stations(self, num_stations, origin, destination):
        while True:
            ...
            if len(station_names) != num_stations:
                print(f"Expected {num_stations} station names but received {len(station_names)}.")
                continue
    ...
    def creating(self):
        while True:
            try:
                ...
                while True:
                    stations_number = safe_input("Number of stations: ").strip()
    ...
    def editing(self):
        while True:
            ...
            while True:
                reference = ["origin", "destination", "number of stations", "stations"]
                feature = safe_input(
                ...
                if feature not in reference:
                    print(f"There is no feature named '{feature}'. Please try again.")
                    continue
