...
class Line:
    ...
    def add_line(self):
        ...
        print(f"you are creating a new line in name {line_name} with origin: {origin} and destination: {destination} and staions list of {stations_list} and {number} stations")
        while True:
            ok = input("Is the information confirmed or are you rebuilding the line? \n"
            "1) ok \n"
